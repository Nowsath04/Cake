        ...
        <>
            <div className='ogcard_maindiv'>
                <div className='og_heading_div'>
                    <div className='sub-heading'><img className='sub-heading_img' src='\assets\images\CasinoLobby\c24x24.svg' /> CAKE Originals</div>
                    <div className='og_arrow_div'>
                        <button
                            className={`swiper-button-prev1 ${isBeginning ? 'disabled' : ''}`}
                        ...
                        <button
                            className={`swiper-button-next1 ${isEnd ? 'disabled' : ''}`}
